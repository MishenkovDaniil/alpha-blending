...
naive: 	alpha_blending_0.cpp
		$(CC) $(Flags) alpha_blending_0.cpp -o not-optimized
		./not-optimized
not_optimized: alpha_blending_1.cpp	
		$(CC) $(Flags) alpha_blending_1.cpp -o optimized-1
		./optimized-1
optimized: alpha_blending_2.cpp	
		$(CC) $(Flags) alpha_blending_2.cpp -o optimized-2
		./optimized-2
